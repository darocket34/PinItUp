...
function PinModal({user, type}) {
    ...
    const handleSubmit = async (e) => {
        ...
        setErrors({"errors": Object.values(errorObj)})
        let resPin
        if (!Object.keys(errorObj).length){
            try {
                if (type === "update"){
                    ...
                    uploadForm.append("postDate", pin.postDate);
                    uploadForm.append("boardId", pin.boardId)
                ...
                <div className="pinform create master container">
                    ...
                    <div className="pinform create form container">
                        <form className="pinform create form" id="pinform" onSubmit={handleSubmit}>
                            ...
                            <button className="pinform create submit" type="submit" disabled={false}>Create</button>
                        </form>
                    </div>
                </div>
            )}
